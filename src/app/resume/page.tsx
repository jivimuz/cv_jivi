...
export default function ResumePage() {
  const handleDownload = () => {
    const url =
      "https://drive.usercontent.google.com/u/0/uc?id=1US4Vg24vFcgKK2bqRcesBe2VbyCnvk3u&export=download";

    // Buat elemen <a> untuk trigger download
    const link = document.createElement("a");
    link.href = url;
    link.setAttribute("download", "file.zip"); // nama file opsional
  ...
  return (
    <div>
      <div className="flex w-full justify-between items-center mb-4">
        <h1 className="text-2xl font-bold mb-4 m-4">My Resume</h1>
        <div className=" justify-end">
          <button
            id="download"
            onClick={handleDownload}
            className="btn navbar-bubble shadow-md transition"
          >
            {" "}
            <svg
              width="20"
      ...
      <iframe
        src="https://drive.google.com/file/d/1US4Vg24vFcgKK2bqRcesBe2VbyCnvk3u/preview"
        width="100%"
        height="750px"
        allow="autoplay"
      ></iframe>
